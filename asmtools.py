...
def main():
    ...
    parser.add_argument(
        '--disasm', '-disasm',
        help='Disasm: arm[arm,thumb,mclass,v8],arm64[arm],mips[micro,32,64,32R6,32R6-Micro],x86[16,32,64],ppc[64],sparc[None,v9],systemz[None],xcore[None]',
        default='')
    
    parser.add_argument(
        '--asm', '-asm',
        help='Asm: arm[arm,thumb,mclass,v8],arm64[arm],mips[micro,3,32,64,32R6],x86[16,32,64],ppc[32,64,qpx],sparc[32,64,v9],systemz[None],hexagon[None]',
        default='')
